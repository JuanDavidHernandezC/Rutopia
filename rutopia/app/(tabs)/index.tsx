import { View, Text, ScrollView, TouchableOpacity, StyleSheet, Modal, Image, Dimensions, Platform, SafeAreaView } from 'react-native';
...
// Verifica que la ruta sea correcta: subir 3 niveles suele ser lo estándar en Expo Router
...
export default function HomeScreen() {
  ...
  // Ordenar lugares por calificación
  ...
  return (
    <ScrollView style={s.screen} showsVerticalScrollIndicator={false}>
      ...
      {/* Hero Section - LOGO MÁS GRANDE Y CENTRADO VERTICALMENTE */}
      <LinearGradient 
...
const s = StyleSheet.create({
  ...
  logoHeader: { width: 110, height: 110 }, // LOGO MÁS GRANDE (Antes 80)
