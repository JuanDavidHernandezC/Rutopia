...
export const EMPRENDEDORES: Emprendedor[] = [
  { id:'1', nombre:'Ana María Rodríguez', negocio:'Café Lililu', categoria:'Cafés', descripcion:'Productora de café de especialidad con 5 años de experiencia. Ofrece increible sabor en sus bebidas y en tu vida.', municipio:'Cajicá', email:'ana@cafemontana.co', whatsapp:'573127511921',instagram:'lililu.eventos', calificacion:4.9, color:'#92400e' },
  { id:'2', nombre:'Carlos Fonseca', negocio:'Finca El Paraíso', categoria:'Ecoturismo', descripcion:'Agroturismo familiar con cabañas ecológicas, huerta orgánica y experiencias rurales para familias y grupos.', municipio:'Cajicá', email:'carlos@fincaparaiso.co',  whatsapp:'573127511921',instagram:'carlosfonsecaof', calificacion:4.7, color:'#16a34a' },
  { id:'3', nombre:'Luz Stella Mora', negocio:'Artesanías Chía', categoria:'Cultura', descripcion:'Artesana con 20 años creando piezas en cerámica y tejido con diseños muiscas. Talleres para turistas.', municipio:'Chía', email:'luz@artesaniaschia.co', calificacion:4.5,  whatsapp:'573127511921',instagram:'luzestella.lancheros', color:'#7c3aed' },
  { id:'4', nombre:'Pedro Gutiérrez', negocio:'Al Carbon', categoria:'Gastronomía', descripcion:'Chef campesino especializado en cocina de autor con ingredientes de la Sabana. Cenas privadas y eventos.', municipio:'Tabio', email:'pedro@saborescampo.co',  whatsapp:'573127511921',instagram:'pedrogutierrezr_', calificacion:4.8, color:'#f59e0b' },
  { id:'5', nombre:'Manuela Torres', negocio:'Yoga & Naturaleza', categoria:'Ecoturismo', descripcion:'Retiros de bienestar en medio de la naturaleza. Yoga, meditación y senderismo consciente en la Sabana.', municipio:'Cajicá', email:'manuelatorres.ugc@gmail.com',  whatsapp:'573127511921',instagram:'manuelatorressalazar', calificacion:4.6, color:'#0284c7' },
];
